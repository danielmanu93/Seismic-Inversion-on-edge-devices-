...
if __name__ == '__main__':
    ...
    #suffix = '3_357_raw'
    dataset = FWIDataset(f'/vast/home/dmanu/Desktop/UPFWI/relevant_files/SaltDown_train.txt',
    ...
    if save:
        print('Saving...')
        torch.save(train_set, f'/vast/home/dmanu/Desktop/UPFWI/relevant_files/SaltDown_train.pth')
        torch.save(valid_set, f'/vast/home/dmanu/Desktop/UPFWI/relevant_files/salt_down_valid.pth')
        print('Verifying...')
        train_set_verify = torch.load(f'/vast/home/dmanu/Desktop/UPFWI/relevant_files/SaltDown_train.pth')
        valid_set_verify = torch.load(f'/vast/home/dmanu/Desktop/UPFWI/relevant_files/salt_down_valid.pth')

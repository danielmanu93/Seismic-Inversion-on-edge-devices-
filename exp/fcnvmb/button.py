...
def orig_no_noise_pred(scale_value=0):
    ...
    if check_5.get() == 1 and check_4.get() == 0 and check_unet.get() == 0 and check_noiseunet.get() == 0 and check_inv.get() == 1 and check_noiseinv.get() == 0:
        ...
        model = "FCN4_1"
        up_mode = None
        resume = '/home/pi/Desktop/exp/fcnvmb/UPFWI/checkpoints/fcn_kimb_1/no_noise_inversion/model_500.pth'
        vis=True
        vis_suffix = '500_test'
        vis_batch = 1
        vis_sample = 1
    ...
    if check_5.get() == 1 and check_4.get() == 0 and check_unet.get() == 0 and check_noiseunet.get() == 0 and check_inv.get() == 0 and check_noiseinv.get() == 1:
        ...
        model = "FCN4_1"
        up_mode = None
        resume = '/home/pi/Desktop/exp/fcnvmb/UPFWI/checkpoints/fcn_kimb_1/noise_inversion/model_500.pth'
        vis=True
        vis_suffix = '500_test'
        vis_batch = 1
        vis_sample = 1

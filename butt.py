...
import utils
import network
from vis import plot_kimb_velocity, plot_kimb_seismic, plot_kimb_trace, plot_kimb_profile, display_annot_seismic
...
saltImg = ImageTk.PhotoImage(Image.open('/home/pi/Desktop/exp/fcnvmb/images/salt.png').resize((80, 35), Image.ANTIALIAS))
datamenu.add_command(image=saltImg, command=open_salt)
kimbImg = ImageTk.PhotoImage(Image.open('/home/pi/Desktop/exp/fcnvmb/images/kim.png').resize((80, 35), Image.ANTIALIAS))
...
data_checkFrame = LabelFrame(root, text=" List of Data ", font=("helvetica", 13), labelanchor="n", width=470, height=257, bg="gray80", bd=4, relief=GROOVE)
data_checkFrame.place(x=1448, y=739)
...
img9 = ImageTk.PhotoImage(Image.open('/home/pi/Desktop/exp/fcnvmb/images/noise.png').resize((100, 25), Image.ANTIALIAS))
...
seis_scaler_label = customtkinter.CTkLabel(master=root, text="Zoom Seismic ", text_font=("helvetica", 13), width=220, image=img1, compound=RIGHT,  
                                        fg_color="gray80", corner_radius=1).place(x=35, y=110)
...
noise_scaler_label = customtkinter.CTkLabel(master=root, text=" Noise (dB) ", text_font=("helvetica", 13), width=100, image=img9, compound=RIGHT, 
                                    fg_color="gray80", corner_radius=1).place(x=615, y=95)
    ...
    if check_4.get() == 0 and check_5.get() == 1:
        ...
        if check_1.get() == 1:
            ...
            if (scale.get()) == 0:
                ...
                seis_rec1 = int(var11.get())
                seis_rec2 = int(var12.get()) 
                seis_rec3 = int(var13.get())
            ...
            if (scale.get()) == 5:
                ...
                if vis:
                    ...
                    if vis and batch_idx < vis_batch:
                        display_annot_seismic(seis, seis_rec1, seis_rec2, seis_rec3, f'{vis_path}/Seismic.png')
                        plot_kimb_trace(trace1, trace2, trace3, f'{vis_path}/Trace.png')
            ...
            if len(seis_channel_num.get()) != 0:
                ...
                if (scale.get()) == 0:
                    ...
                    trace1 = images[0,seis_chann,:,seis_rec1]
                    trace2 = images[0,seis_chann,:,seis_rec2]
                    trace3 = images[0,seis_chann,:,seis_rec3]
...
salt_seis_receiver_label = customtkinter.CTkLabel(master=root, text="Enter Salt Receiver No. (Range: 0 - 300)", text_font=("helvetica", 13),
                            image=img3, compound=RIGHT, fg_color="gray80", corner_radius=1).place(x=60, y=190)
...
seis_channel_num.place(x=332, y=155, width=60, height=25)
vel_set1 = customtkinter.CTkLabel(master=root, text="Enter Seismic Source No. \n(Range: 0 - 9)", text_font=("helvetica", 13), width=25, fg_color="gray80", corner_radius=1).place(x=255, y=110)
...
var11 = StringVar()
kimb_receiver = Entry(root, textvariable=var11, font = ("Times", 12, "bold"), bg="gray80", justify=CENTER, highlightthickness=2)
kimb_receiver.config(highlightbackground="red", highlightcolor="red")
kimb_receiver.place(x=600, y=250, width=60, height=25)

var12 = StringVar()
kimb_receiver = Entry(root, textvariable=var12, font = ("Times", 12, "bold"), bg="gray80", justify=CENTER, highlightthickness=2)
kimb_receiver.config(highlightbackground="blue", highlightcolor="blue")
kimb_receiver.place(x=692, y=250, width=60, height=25)

var13 = StringVar()
kimb_receiver = Entry(root, textvariable=var13, font = ("Times", 12, "bold"), bg="gray80", justify=CENTER, highlightthickness=2)
kimb_receiver.config(highlightbackground="black", highlightcolor="black")
kimb_receiver.place(x=785, y=250, width=60, height=25)

seis_set1 = customtkinter.CTkLabel(master=root, text="Set 1", text_font=("helvetica", 13), width=25, fg_color="gray80", corner_radius=1).place(x=607, y=220)
seis_set2 = customtkinter.CTkLabel(master=root, text="Set 2", text_font=("helvetica", 13), width=25, fg_color="gray80", corner_radius=1).place(x=699, y=220)
seis_set3 = customtkinter.CTkLabel(master=root, text="Set 3", text_font=("helvetica", 13), width=25, fg_color="gray80", corner_radius=1).place(x=792, y=220)

kimb_seis_receiver_label = customtkinter.CTkLabel(master=root, text="Enter Kimberlina Receiver No. (Range: [0 - 100] x 40)", text_font=("helvetica", 13),
                            image=img3, compound=RIGHT, fg_color="gray80", corner_radius=1).place(x=490, y=190)
...
salt_data_check = Checkbutton(root, text = '  Salt Data', font = ("helvetica", 13), bd=0, variable = check_4, compound="left", image=uncheck,
                selectimage=check, indicatoron=False, selectcolor="gray80", bg="gray80", activebackground="gray80", command=())
salt_data_check.place(x=1465, y=760)

kimb_data_check = Checkbutton(root, text = '  Kimberlina Data', font = ("helvetica", 13), bd=0, compound="left", variable = check_5,
                image=uncheck, selectimage=check, indicatoron=False, selectcolor="gray80", bg="gray80", activebackground="gray80", command=())
kimb_data_check.place(x=1465, y=790) 
...
modelmenu.add_checkbutton(label="No-noise UNet                  ", font = ("helvetica", 14), compound="right",
                image=unet_nonoise_uncheck, activebackground="gray80", command=TestingPD)
modelmenu.add_checkbutton(label="Noise-aware UNet            ", font = ("helvetica", 14), compound="right", 
                image=unet_noise_uncheck, activebackground="gray80", command=NoisePD)
modelmenu.add_checkbutton(label="No-noise InversionNet      ", font = ("helvetica", 14), compound="right", 
                image=inv_nonoise_uncheck, activebackground="gray80", command=main)
modelmenu.add_checkbutton(label="Noise-aware InversionNet", font = ("helvetica", 14), compound="right",
                image=inv_noise_uncheck, activebackground="gray80", command=())
